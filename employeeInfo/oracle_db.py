...
query = 'SELECT PYOFMAIL, PYEMPCDE, PYEMPNAM, PRESENT_DESIGNATION, PYHEADER, PHONE_NUMBER, DUTY_DESK, DUTY_DESK_CODE, PYDEPNAM, SUB_DIVISION, PYOFMAIL, EMP_STATUS, LAST_BRANCH FROM ORBHRM.V_EMP_DUTY_DSK_DTL WHERE PYEMPCDE='
