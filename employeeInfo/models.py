...
class Service_request(models.Model):
    ...
    to_date = models.DateField(max_length=100,blank=True)
    to_date_check = models.BooleanField(max_length=100,blank=True)
    from_time = models.TimeField(max_length=100,blank=True)
    to_time = models.TimeField(max_length=100,blank=True)
    to_time_check = models.BooleanField(max_length=100,blank=True)
