...
class RequestForm(forms.ModelForm):
    ...
    department = forms.CharField(widget=forms.TextInput(attrs={'value':'','class': 'form-control', 'list': 'departmentSuggestions','placeholder': 'Please enter department', 'aria-label': 'LabelDepartment', 'aria-describedby': 'addon-wrapping'}))
